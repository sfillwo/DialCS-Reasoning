...
from modeling.models.response_model.gpt_latentselection_prompt import prompt, parse, type_sentence_prefix

CHATGPT_35_LATENTSELECTION_0125 = GPTChatResponderOnestage(
    name="chatgpt_35_latentselection_0125",
